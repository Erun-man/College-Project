...
<html lang="en">
  <head>
    ...
    <title>Phil Oasis | Message Section</title>
          ...
          <div class="col-md-3">
            <div class="list-group">
              ...
              <a href="client_home.php" class="list-group-item" ><span class="fa fa-home" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;Home</li></a>
               ...
               <a href="my_account.php" class="list-group-item"><span class="fa fa-gear" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;Appointment</li></a>
            
              <a href="client_message.php" class="list-group-item" style="background-color: #f4f4f4;"><span class="fa fa-pencil" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;Write Message</a><br>
          ...
          <div class="col-md-9">
            ...
            <div class="panel panel-default">
              <div class="panel-heading main-color-bg">
                ...
                <h3 class="panel-title fa fa-send">&nbsp;&nbsp;Message Us</h3>
              ...
              <div class="container">
        <div class="row">
          <font face="century gothic"><p style="margin-left: 190px">If you have any concern and question kindly message us.</p></font>
          <div class="col-md-8">
            
            <form class="form-horizontal" action="client_message_db.php" method="post"><br><br> 
            <p><b>Email Address</p></b>       
               <input type="email" class="form-control" name="email_msg" value="" required=""><br>
                <p><b>Message</p></b>   
                <input type="textbox" class="form-control" name="msg" placeholder="Your message here..." required=""> 
              <div class="form-group"><br><br>
                ...
                <button class="btn btn-primary pull-right" id="create">Send Now</button>
              </div>
