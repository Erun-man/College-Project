      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="clients_information.php">Incoming Clients</a></li>
        ...
        <div class="row">
          <div class="col-md-3">
            <div class="list-group">
             ...
             <a href="clients_information.php" class="list-group-item" style="background-color: #cacdd4"><span class="fa fa-user-o" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;Incoming Clients</a>
                ...
                <form method="POST">
                    ...
                    <?php
                      ...
                      if (isset($_POST['search']))
                      {
                        ...
                        {
                          $query = $conn->query("SELECT * FROM `reservation` WHERE (`first_name` LIKE '%$word%') OR (`last_name` LIKE '%$word%')  OR (`bed_type` LIKE '%$word%') AND `status` = 'incoming'");
                        }
                        while ($row = $query->fetch_assoc())
                         ...
                         <div class="col-md-3" style="display: none">
                          ...
                          <div class="col-md-3">
                            <div class="row">
                              <form action="client_approve_db.php"><button id="approve" class="pull-right">Approve this client</button>
                               </form>
                            </div>
                          </div>
                           <div class="col-md-3">
                            <div class="row">
                              <form action="delete_client_db.php"><button id="cancel" class="pull-left">Delete</button>
                               </form>
                            </div>
                          </div>
            ...
            <div class="panel panel-default">
              <div class="panel-heading main-color-bg">
               ...
               ?>
                ...
                <?php
                while ($reservation = mysqli_fetch_assoc($records)) {
                     
                     $id = $reservation['id'];
                      $_SESSION['id'] = $reservation['id'];

                     $_SESSION['fn'] = $reservation['first_name'];
                     $fn = $_SESSION['fn'];
                     

                     $_SESSION['ln'] = $reservation['last_name'];
                     $ln = $_SESSION['ln'];

                      $_SESSION['email'] = $reservation['email'];
                     $email = $_SESSION['email'];

                      $_SESSION['phone'] = $reservation['phone'];
                     $phone = $_SESSION['phone'];

                     $_SESSION['bt'] = $reservation['bed_type'];
                     $bt = $_SESSION['bt'];

                     $_SESSION['cin'] = $reservation['cin'];
                     $cin = $_SESSION['cin'];

                     $_SESSION['cout'] = $reservation['cout'];
                     $cout = $_SESSION['cout'];

                     $_SESSION['nod'] = $reservation['Number_of_days'];
                     $nod = $_SESSION['nod'];

                     $_SESSION['pay'] = $reservation['Payment'];
                     $pay = $_SESSION['pay'];

                     // $first_name = $_SESSION['first_name']
                     // $_SESSION['first_name'] = $reservation['first_name'];

                     // $last_name = $reservation['last_name'];
                     // $_SESSION['last_name'] = $reservation['last_name'];

                     // $email = $reservation['email'];
                     // $_SESSION['email'] = $reservation['last_name'];
                     ...
                     echo "<td>".$reservation['bed_type']."</td>";
                     echo "<td>".$reservation['cin']."</td>";
                     echo "<td>".$reservation['cout']."</td>";
                     echo "<td>".$reservation['Number_of_days']." days"."</td>";
                     echo "<td>"."PHP ".$reservation['Payment'].".00"."</td>";
                 ?>
                 <!-- <td><a href = "approve_client1_db.php?approve=<?php echo $id; ?>"><button class="check" title="Approve "></button></a></td> -->
                 <td><a href = "delete_client1_db.php?delete=<?php echo $id; ?>"><button class="cross" title="Delete "></button></a></td>
               </tr>
               <?php 
               } 
                ?> 
